...
/// A physical keyboard shortcut suitable for Carbon's global hot-key API.
struct KeyboardShortcut: Codable, Equatable {
    ...
    /// Avoids shortcuts that can be triggered by ordinary typing.
    ...
    private static let supportedModifierMask = UInt32(
    ...
    private static func keyName(for keyCode: UInt32) -> String {
        ...
        default: return String(format: "Key %u", keyCode)
        }
    }
}
